...
extension ArenaRenderer {
    ...
    func buildEnchantedTerrain(){
        ...
        // The 0.067-unit wave amplitude must remain above the riverbed and below the bridge deck.
        let water=mesh(waterGeo,UIColor(rgb:0x176D72),SCNVector3(50,0.14,-50),world,metal:0.22);water.eulerAngles=SCNVector3(-Float.pi/2,Float.pi/4,0)
