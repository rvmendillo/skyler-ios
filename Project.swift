...
let project = Project(
    ...
    packages: [
        .remote(url: "median.go-native-core", requirement: .exact("3.0.5")),
        ...
        // Active plugins are injected here by the builder at build time.
                .remote(url: "median.one-signal-plugin", requirement: .exact("1.2.0")),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                // Active plugin dependencies are injected here by the builder at build time.
                        .package(product: "OneSignalPlugin"),
        ...
        .target(
            ...
            bundleId: "co.median.ios.yezoeal.OneSignalNotificationServiceExtension",
            deploymentTargets: .iOS("15.5"),
            infoPlist: .file(path: "Extensions/OneSignalNotificationServiceExtension/Info.plist"),
            sources: ["Extensions/OneSignalNotificationServiceExtension/NotificationService.m", "Extensions/OneSignalNotificationServiceExtension/NotificationService.h"],
entitlements: .file(path: "Extensions/OneSignalNotificationServiceExtension/OneSignalNotificationServiceExtension.entitlements"),
            dependencies: [
                .package(product: "OneSignal")
            ]
        ),
    ]
)